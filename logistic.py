...
for index,i in zip(dataset.index,dataset['production_companies']):
    list1=[]
    for j in range(len(i)):
        list1.append((i[j]['name']))# the key 'name' contains the name of the production company
...
# all_pc contain all the production_companies with repetition
# unique_pc will contain unique
unique_pc = []
all_pc = []
