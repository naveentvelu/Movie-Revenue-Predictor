...
# scal = max(dataset['revenue']) - min(dataset['revenue'])
# for i in range(0,len(dataset)):
#     dataset.loc[i,'revenue'] /= scal
...
#Importing the file and trying to run it doesn't
#work. Just load the function of the below file
#in the IPython Interpreter and then run below commands.            
